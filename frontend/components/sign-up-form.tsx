          ...
          <form className="p-6 md:p-8 flex items-center justify-center">
            <div className="flex flex-col gap-6 w-full md:w-full xl:max-w-md sm:w-full xs:w-full">
              <div className="flex flex-col text-left">
                <h1 className="text-2xl font-bold font-mona-sans">Cuéntanos de ti</h1>
              ...
              <div className="text-center text-sm">
                ...
                <a href="/auth/sign-up" className="hover:underline hover:underline-offset-4 font-bold font-mona-sans">
